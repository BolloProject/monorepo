...
export const WETH = {
  ...
  [ChainId.TC_MAINNET]: new Token(ChainId.TC_MAINNET, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WTC', 'Wrapped TC'),
  [ChainId.TC_TESTNET]: new Token(ChainId.TC_TESTNET, '0x105012F78e5730796c1F36Fb1D24949cd61cAD27', 18, 'WTC', 'Wrapped TC')
}
